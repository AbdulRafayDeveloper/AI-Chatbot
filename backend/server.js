...
async function runChat(userInput) {
  ...
  const chat = model.startChat({
    ...
    history: [
      ...
      {
        role: "user",
        parts: [{ text: "You are a chatbot that only answers questions related to mobile phones. If a user asks about anything else, respond with: 'I can only answer questions related to mobile phones. Please ask me about mobile phones.'" }],
      },
      {
        role: "model",
        parts: [{ text: "Hello! I'm here to answer your questions about mobile phones. How can I help you today?" }],
      },
    ],
  });
